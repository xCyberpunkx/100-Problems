...
int NegativeCountInArray( int array[100], int arrayLength) {
	int counter = 0;
...
void PrintNegativeArrayCount(int arr[100], int arrlength)
{

		cout << NegativeCountInArray(arr,arrlength) << " ";
	cout << "\n";
}
...
int main()
{
	...
	cout << "Negative: \n";
	PrintNegativeArrayCount(arr, arrLength);
