...
int EvenCountInArray( int array[100], int arrayLength) {
	int counter = 0;
...
void PrintEvenArrayCount(int arr[100], int arrlength)
{

		cout << EvenCountInArray(arr,arrlength) << " ";
	cout << "\n";
}
...
int main()
{
	...
	cout << "Even: \n";
	PrintEvenArrayCount(arr, arrLength);
