...
int oddCountInArray( int array[100], int arrayLength) {
	int counter = 0;
...
void PrintOddArrayCount(int arr[100], int arrlength)
{

		cout << oddCountInArray(arr,arrlength) << " ";
	cout << "\n";
}
...
int main()
{
	...
	cout << "Odd: \n";
	PrintOddArrayCount(arr, arrLength);
